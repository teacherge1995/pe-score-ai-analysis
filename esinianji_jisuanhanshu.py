from zgFeiHuoLiang_BiaoZhun import sinianji_nan_feihuoliang_jisuan_fenshu, sinianji_nv_feihuoliang_jisuan_fenshu
from zbTiaoSheng_BiaoZhun import sinianji_nan_tiaosheng_jisuan_fenshu, sinianji_nv_tiaosheng_jisuan_fenshu
from zcZuoWeiTiQianQu_BiaoZhun import sinianji_nan_zuoweitiqianqu_jisuan_fenshu, sinianji_nv_zuoweitiqianqu_jisuan_fenshu
from zaWuShiMi_BiaoZhun import sinianji_nan_wushimi_jisuan_fenshu, sinianji_nv_wushimi_jisuan_fenshu
from zdYangWoQiZuo_BiaoZhun import sinianji_nan_yangwoqizuo_jisuan_fenshu, sinianji_nv_yangwoqizuo_jisuan_fenshu
from zfJiaCeXiangMu_BiaoZhun import 四年级男生立定跳远计算分数,四年级女生立定跳远计算分数
from zhBMI_BiaoZhun import 四年级男生体重指数计算分数,四年级女生体重指数计算分数
    ...
    for row in data_list:
        try:
            ...
            if gender in ['男', '男生']:
                ...
                wushimi_func = sinianji_nan_wushimi_jisuan_fenshu
                tiaosheng_func = sinianji_nan_tiaosheng_jisuan_fenshu
                zuoweitiqianqu_func = sinianji_nan_zuoweitiqianqu_jisuan_fenshu
                yangwoqizuo_func = sinianji_nan_yangwoqizuo_jisuan_fenshu
                lidingtiaoyuan_func = 四年级男生立定跳远计算分数
                feihuoliang_func = sinianji_nan_feihuoliang_jisuan_fenshu
                Bmi_func = 四年级男生体重指数计算分数(Bmi)
    ...
    for row in data_list:
        try:
            ...
            if gender in ['女', '女生']:
                ...
                wushimi_func = sinianji_nv_wushimi_jisuan_fenshu
                tiaosheng_func = sinianji_nv_tiaosheng_jisuan_fenshu
                zuoweitiqianqu_func = sinianji_nv_zuoweitiqianqu_jisuan_fenshu
                yangwoqizuo_func = sinianji_nv_yangwoqizuo_jisuan_fenshu
                lidingtiaoyuan_func = 四年级女生立定跳远计算分数
                feihuoliang_func = sinianji_nv_feihuoliang_jisuan_fenshu
                Bmi_func = 四年级女生体重指数计算分数(Bmi)
