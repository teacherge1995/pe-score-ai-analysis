def ernianji_sort_by_index5(all_rows):
    """
    ...
    try:
        ...
        wushimi_result = [[x[0], x[2], x[3], x[43],x[1], x[4]] for x in wushimi_paixu]
        ...
        # 三项总分
        sanxiangzongfen_nan_lst = qianshiwuming(17, 18, boy_rows, '三项总分')
        # 仰卧起坐
        yangwoqizuo_nan_lst = qianshiwuming(20, 21, boy_rows, '仰卧起坐')
        # 四项总分
        sixiangzongfen_nan_lst = qianshiwuming(25, 26, boy_rows, '四项总分')
        ...
        # 三项总分
        sanxiangzongfen_nv_lst = qianshiwuming(17, 18, girl_rows, '三项总分')
        # 仰卧起坐
        yangwoqizuo_nv_lst = qianshiwuming(20, 21, girl_rows, '仰卧起坐')
        # 四项总分
        sixiangzongfen_nv_lst = qianshiwuming(25, 26, girl_rows, '四项总分')
        ...
        final_rows = (wushimi_nan_lst + wushimi_nv_lst +
                      ...
                      sanxiangzongfen_nan_lst + sanxiangzongfen_nan_lst+
                      yangwoqizuo_nan_lst + yangwoqizuo_nv_lst +
                      sixiangzongfen_nan_lst+ sixiangzongfen_nan_lst)
        # for i in final_rows:
        #     print(i)
...
def qianshiwuming(suoyin1,suoyin2,boy_rows,xiangmu):
    ...
    # 保留                序号    性别  排序   班级    姓名  成绩
    list_result = [[x[0], x[2], x[3], x[43], x[1], x[suoyin2]] for x in list_paixu]
