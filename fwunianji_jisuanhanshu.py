from zgFeiHuoLiang_BiaoZhun import wunianji_nan_feihuoliang_jisuan_fenshu, wunianji_nv_feihuoliang_jisuan_fenshu
from zeWuShiChengBa_BiaoZhun import wunianji_nan_wushichengba_jisuan_fenshu, wunianji_nv_wushichengba_jisuan_fenshu
from zbTiaoSheng_BiaoZhun import wunianji_nan_tiaosheng_jisuan_fenshu, wunianji_nv_tiaosheng_jisuan_fenshu
from zcZuoWeiTiQianQu_BiaoZhun import wunianji_nan_zuoweitiqianqu_jisuan_fenshu, wunianji_nv_zuoweitiqianqu_jisuan_fenshu
from zaWuShiMi_BiaoZhun import wunianji_nan_wushimi_jisuan_fenshu, wunianji_nv_wushimi_jisuan_fenshu
from zdYangWoQiZuo_BiaoZhun import wunianji_nan_yangwoqizuo_jisuan_fenshu, wunianji_nv_yangwoqizuo_jisuan_fenshu
...
from zfJiaCeXiangMu_BiaoZhun import 五年级直臂悬垂计算分数
from zhBMI_BiaoZhun import 五年级男生体重指数计算分数,五年级女生体重指数计算分数
import random
    ...
    for row in data_list:
        try:
            ...
            if gender in ['男', '男生']:
                ...
                wushimi_func = wunianji_nan_wushimi_jisuan_fenshu
                tiaosheng_func = wunianji_nan_tiaosheng_jisuan_fenshu
                zuoweitiqianqu_func = wunianji_nan_zuoweitiqianqu_jisuan_fenshu
                yangwoqizuo_func = wunianji_nan_yangwoqizuo_jisuan_fenshu
                wushichengba_func = wunianji_nan_wushichengba_jisuan_fenshu
                zhibixuanchui_func = 五年级直臂悬垂计算分数
                feihuoliang_func = wunianji_nan_feihuoliang_jisuan_fenshu
                Bmi_func = 五年级男生体重指数计算分数(Bmi)
    ...
    for row in data_list:
        try:
            ...
            if gender in ['女', '女生']:
                ...
                wushimi_func = wunianji_nv_wushimi_jisuan_fenshu
                tiaosheng_func = wunianji_nv_tiaosheng_jisuan_fenshu
                zuoweitiqianqu_func = wunianji_nv_zuoweitiqianqu_jisuan_fenshu
                yangwoqizuo_func = wunianji_nv_yangwoqizuo_jisuan_fenshu
                wushichengba_func = wunianji_nv_wushichengba_jisuan_fenshu
                feihuoliang_func = wunianji_nv_feihuoliang_jisuan_fenshu
                Bmi_func = 五年级女生体重指数计算分数(Bmi)
